...
message("Number of categorical features in model: ", length(model_features))
...
# Function to Create Template for Simulations

We'll create a function to generate template data for our simulations:
...
# Scenario 1: Impact of Location on Demand

In this scenario, we'll simulate how location affects rental demand:
...
# Scenario 2: Impact of Price on Demand

This scenario examines how price affects rental demand:
...
# Scenario 3: Combined Impact of Property Type and Room Type

This scenario examines how property type and room type together affect demand:

```{r property_room_simulation}
...
# Scenario 4: Impact of Host Experience and Status

This scenario examines how host experience and superhost status affect demand:

```{r host_experience_simulation}
...
# Scenario 5: Optimizing Price for Maximum Demand by Location

This scenario finds the optimal price point for different neighborhoods:

```{r price_optimization_simulation}
...
# Create a simple summary of key findings
...
Based on our simulations, we can provide several key insights and recommendations:

## Key Insights

1. **Location Matters**: The neighborhood has a significant impact on demand, with central areas like Mitte and Friedrichshain showing higher demand.

2. **Price Optimization**: There's an optimal price point for each property that maximizes demand. Setting prices too high or too low can both negatively impact demand.

3. **Property Configuration**: Entire homes/apartments generally have higher demand than private or shared rooms across all property types.

4. **Host Experience**: More experienced hosts and those with superhost status tend to attract more demand, likely due to reputation effects.

## Recommendations for Hosts

1. **Location-Based Pricing**: Set prices based on your specific neighborhood. Our analysis shows the optimal price varies significantly by location.

2. **Property Type Considerations**: If possible, offer entire homes/apartments as they generally have higher demand than private or shared rooms.

3. **Superhost Status**: Working toward superhost status can significantly increase demand for your property.

4. **Price Testing**: Consider testing different price points around the optimal price for your neighborhood to find the sweet spot for your specific property.

These insights can help hosts make data-driven decisions to optimize their listings and maximize rental demand. 